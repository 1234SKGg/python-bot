...
BOT_TOKEN = "7048556728:AAFgEw7IXAc61ld-DfOVEq2otrKTI-8hos0"
PAYMENT_CHANNEL = "@payaaaaaaaaaa" #add payment channel here including the '@' sign
OWNER_ID = 6625552307 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@hackchatdisc"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
